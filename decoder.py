...
class BasicDecoder(decoder.Decoder):
  ...
  def initialize(self, name=None):
    ...
    return (self._helper.initialize()[0], concat([self._helper.initialize()[1], self._latent_vector], axis=-1)) + (self._initial_state,)
  ...
  def step(self, time, inputs, state, name=None):
    ...
    with ops.name_scope(name, "BasicDecoderStep", (time, inputs, state)):
      ...
      next_inputs = concat([next_inputs, self._latent_vector], axis=-1)
