...
def model_argparse():
    ...
    parser.add_argument("--device", type=str, default="0", help='tf device')
    ...
    parser.add_argument("--num_classes", type=int, default=4, help='number of different classes in the dataset')
    ...
    parser.add_argument("--learning_rate_decay", type=float, default=0.96, help='learning rate decay')
    parser.add_argument("--min_learning_rate", type=float, default=0.0001, help='minimum learning rate')

    parser.add_argument("--lambda_val", type=float, default=3.0, help='initial value of lambda, i.e., MMD co-efficient')
    parser.add_argument("--gammaKL", type=float, default=1.0, help='co-efficient of the KL regularization term')
...
#    parser.add_argument("--data", type=str, default='../data/gutenberg-poetry-v001.ndjson.gz')
#    parser.add_argument("--data", type=str, default='../../data/friends.txt')
    parser.add_argument("--w2v_file", type=str, default='../../w2v_models/w2v_300d_mnli_all_sentences.pkl')
